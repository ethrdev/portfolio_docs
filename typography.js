module.exports = ({ theme }) => ({
  DEFAULT: {
    css: {
      ...
      '--tw-prose-code-bg': theme('colors.neutral.700 / 0.15'),
  ...
  invert: {
    css: {
      ...
      '--tw-prose-links-hover': 'var(--tw-prose-links-hover)',
      '--tw-prose-links-underline': 'var(--tw-prose-links-underline)',
      ...
      '--tw-prose-code-bg': 'var(--tw-prose-code-bg)',
      '--tw-prose-code-ring': 'var(--tw-prose-code-ring)',

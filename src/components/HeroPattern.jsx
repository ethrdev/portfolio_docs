  ...
  return (
    <div className="absolute inset-0 mx-0 overflow-hidden -z-10 max-w-none">
      <div className="absolute left-1/2 top-0 ml-[-38rem] h-[25rem] w-[81.25rem] [mask-image:linear-gradient(white,transparent)]">
        <div className="absolute inset-0 bg-gradient-to-r [mask-image:radial-gradient(farthest-side_at_top,white,transparent)] from-teal-500/30 to-cyan-500/30 opacity-100">
          <GridPattern
            width={72}
            height={56}
            x="-12"
        ...
        <svg
          ...
          aria-hidden="true"
          className="absolute top-0 left-1/2 ml-[-19rem] w-[69.5625rem] hidden"
        >
